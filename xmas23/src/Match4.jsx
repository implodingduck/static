  ...
  return (
    <>
      <div>
        ...
        <p>Bing Crosby, Danny Kaye, Rosemary Clooney and Vera-Ellen are all connected to White Christmas. Can you help heal the Grinch's heart by finding other groups of four that share a commonality?</p>
      </div>
      <div>
      { answers.map((a, i) => {
        if (a.visible){
